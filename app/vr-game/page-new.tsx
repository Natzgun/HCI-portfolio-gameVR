...
const constellationData: ConstellationNode[] = [
  {
    id: "1",
    title: "Idea",
    phase: "Conceptualización",
    x: 0.2,
    y: 0.3,
    description: "Juego VR de supervivencia espacial donde navegas en gravedad cero usando objetos para impulsarte.",
    mechanics: [
      "Hand Tracking para manipulación de objetos",
      "Física de gravedad cero realista",
      "Sistema de oxígeno limitado",
      "Mecánicas de propulsión con escombros"
    ],
    status: 'completed'
  },
  {
      ...
      {selectedNode && (
        <div className="absolute inset-0 flex items-center justify-center pointer-events-none animate-[fadeIn_0.3s_ease-in-out_forwards]">
          <div className="bg-black/80 backdrop-blur-xl border-2 border-blue-500/50 rounded-2xl p-8 max-w-2xl pointer-events-auto shadow-2xl">
            ...
            <h3 className="text-2xl font-semibold text-blue-400 mb-4">Mecánicas e Interacciones</h3>
